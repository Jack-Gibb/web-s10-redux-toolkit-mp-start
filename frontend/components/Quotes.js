              ...
              >
                ...
                <div className="quote-buttons">
                  <button onClick={() => {
                    ...
                    dispatch(actionToDispatch)/* ✨ dispatch an action */ }}>DELETE</button>
                  <button onClick={() => {dispatch(setHighlightedQuote(qt.id))/* ✨ dispatch an action */ }}>HIGHLIGHT</button>
                  <button onClick={() => {dispatch(editQuoteAuthenticity(qt.id))/* ✨ dispatch an action */ }}>FAKE</button>
                </div>
              </div>
            ))
        }
